...
def clean_response_string(response_str):
    ...
    # Additional cleaning: remove any stray backticks
...
class QuizGenerator:
    ...
    def generate_question_with_vectorstore(self):
        ...
        response_str = clean_response_string(str(response))
    ...
    def generate_quiz(self) -> list:
        ...
        for _ in range(self.num_questions):
            # Generate question using the class method
            question_str = self.generate_question_with_vectorstore()

            # Log the response for debugging purposes
            print("Generated Question String:", question_str)
